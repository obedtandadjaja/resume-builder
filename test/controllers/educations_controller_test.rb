...
class EducationsControllerTest < ActionController::TestCase
  ...
  test "should create education" do
    assert_difference('Education.count') do
      post :create, education: { class_of: @education.class_of, degree: @education.degree, gpa: @education.gpa, is_enrolled: @education.is_enrolled, major: @education.major, minor: @education.minor, resume_id: @education.resume_id }
    end
  ...
  test "should update education" do
    patch :update, id: @education, education: { class_of: @education.class_of, degree: @education.degree, gpa: @education.gpa, is_enrolled: @education.is_enrolled, major: @education.major, minor: @education.minor, resume_id: @education.resume_id }
    assert_redirected_to education_path(assigns(:education))
  end
